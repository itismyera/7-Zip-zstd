...
with any compiler. Zipr's code can work with std::bad_alloc and CNewException() exceptions.
But if you use some additional code (outside of Zipr's code), you must check
